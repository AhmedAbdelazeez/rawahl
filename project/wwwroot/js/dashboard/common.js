...
const translations = {
    'ar': {
        ...
        'kpi-comp-total-violations': 'إجمالي المخالفات المسجلة',
        'kpi-comp-open-violations': 'المخالفات المفتوحة',
        'kpi-comp-closed-violations': 'المخالفات المغلقة',
        'kpi-comp-closure-rate': 'نسبة إغلاق المخالفات',
        'kpi-comp-resolution-time': 'متوسط زمن معالجة المخالفة',
        'kpi-comp-critical-violations': 'عدد المخالفات الحرجة',
        'kpi-comp-total-fines': 'إجمالي قيمة الغرامات',
        'kpi-comp-departments-count': 'عدد الإدارات المخالفة',
        ...
        'card-total-revenue-title': 'إجمالي الإيرادات',
        'card-total-expenses-title': 'إجمالي المصروفات',
        'card-net-profit-title': 'صافي الربح',
        'card-net-profit-margin-title': 'هامش صافي الربح',
        'card-expense-ratio-title': 'نسبة المصروفات إلى الإيرادات',
        'card-avg-monthly-revenue-title': 'متوسط الإيراد الشهري',
        'card-top-expense-title': 'أعلى بند مصروف',
        'card-transactions-count-title': 'عدد الحركات المالية',
        ...
        'val-hse-training-hours-label': 'ساعات التدريب والتوعية بالسلامة',
        'val-hse-inspection-completion-label': 'إنجاز جولات التفتيش الوقائي',
        'val-hse-near-miss-label': 'معدل الإبلاغ عن الحوادث الوشيكة',
        'val-hse-waste-recycling-label': 'معدل إعادة تدوير النفايات التشغيلية',
        ...
        'val-strat-milestones-label': 'إنجاز معالم مبادرات PMO بالوقت',
        'val-strat-budget-label': 'كفاءة استغلال الموازنة الاستراتيجية',
        ...
        'val-hr-ret-label': 'نسبة بقاء الموظفين',
        'val-hr-count-label': 'إجمالي الموظفين',
        'val-hr-active-label': 'الموظفون على رأس العمل',
        'val-hr-leavers-label': 'عدد المغادرين',
        'val-hr-turnover-label': 'معدل دوران الموظفين',
        'val-hr-saudization-label': 'نسبة التوطين والسعودة',
        'val-hr-growth-label': 'متوسط رواتب الموظفين',
        'val-hr-training-label': 'متوسط تقييم أداء الموظفين',
    ...
    'en': {
        ...
        'kpi-comp-total-violations': 'Registered Violations',
        'kpi-comp-open-violations': 'Open Violations',
        'kpi-comp-closed-violations': 'Closed Violations',
        'kpi-comp-closure-rate': 'Violations Closure Rate',
        'kpi-comp-resolution-time': 'Average Resolution Time',
        'kpi-comp-critical-violations': 'Critical Violations',
        'kpi-comp-total-fines': 'Total Fines',
        'kpi-comp-departments-count': 'Departments With Violations',
        ...
        'card-total-revenue-title': 'Total Revenue',
        'card-total-expenses-title': 'Total Expenses',
        'card-net-profit-title': 'Net Profit',
        'card-net-profit-margin-title': 'Net Profit Margin',
        'card-expense-ratio-title': 'Expense-to-Revenue Ratio',
        'card-avg-monthly-revenue-title': 'Average Monthly Revenue',
        'card-top-expense-title': 'Top Expense Category',
        'card-transactions-count-title': 'Ledger Entries',
        'val-hr-ret-label': 'Employee Retention Rate',
        'val-hr-count-label': 'Total Employees',
        'val-hr-active-label': 'Active Employees',
        'val-hr-leavers-label': 'Leavers',
        'val-hr-turnover-label': 'Employee Turnover Rate',
        'val-hr-saudization-label': 'Saudization Rate',
        'val-hr-growth-label': 'Average Salary',
        'val-hr-training-label': 'Average Employee Rating',
        ...
        'val-hse-ltifr-label': 'LTIFR Work Injury Incident Rate',
        'val-hse-accidents-label': 'Serious Road Bus Accidents Count',
        'val-audit-comp-label': 'HSE Regulatory Compliance Rate',
        'val-hse-training-hours-label': 'HSE Training & Safety Awareness Hours',
        'val-hse-inspection-completion-label': 'Safety Inspections Completion Rate',
        'val-hse-near-miss-label': 'Near-Miss Reporting Count',
        'val-hse-waste-recycling-label': 'Operational Waste Recycling Rate',
        ...
        'group-strategy-perf-title': 'Strategy & PMO Governance Department',
        'support-strategy-title': 'Strategy & Initiatives',
        'val-strat-goals-label': 'Strategic Objectives Achievement',
        'val-strat-init-label': 'PMO Initiative Delivery Rate',
        'support-risk-gov-title': 'Risk Management & Governance',
        'val-risk-handling-label': 'Enterprise Risk Mitigation Rate',
        'val-gov-maturity-label': 'Corporate Governance Maturity',
        'val-strat-goals-achieve-label': 'Combined Strategic Performance Index',
