...
const translations = {
    'ar': {
        ...
        'val-hr-ret-label': 'نسبة استبقاء الموظفين',
        'val-hr-saudization-label': 'نسبة التوطين والسعودة',
        'val-hr-count-label': 'إجمالي عدد الموظفين',
        'val-hr-growth-label': 'متوسط رواتب الموظفين',
        'val-hr-absence-label': 'متوسط المهام لكل موظف',
        'val-hr-training-label': 'متوسط تقييم أداء الموظفين',
        'val-hr-appraisal-label': 'متوسط نتائج التقييمات',
    ...
    'en': {
        ...
        'val-hr-absence-label': 'Average Tasks per Employee',
        'val-hr-training-label': 'Average Employee Rating',
        'val-hr-appraisal-label': 'Average Evaluation Score',
