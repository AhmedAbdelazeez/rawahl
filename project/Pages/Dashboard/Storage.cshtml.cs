...
namespace project.Pages.Dashboard
{
    ...
    public class StorageModel : PageModel
    {
        ...
        public StorageModel(IDepartmentAccessService departmentAccessService, ICurrentUserService currentUserService)
        {
        ...
        {
            if (!await _departmentAccessService.CanAccessDepartmentAsync("storage"))
            {
